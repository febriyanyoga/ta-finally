                    ...
                    <tbody>
                      ...
                      foreach ($data_kegiatan as $kegiatan) {
                       ...
                       if($progress_staf_keu > 0){ //sudah ada input staf keu
                        ...
                        if($progress_tolak == 1){
                         ...
                         if($progress == 1){
                          ...
                          if($input_id == $own_id && $id_max == $own_id){
                            ?>
                            <a class="label label-success" href="#modal_progress" id="custID" data-toggle="modal" data-id="<?php echo $kegiatan->kode_kegiatan;?>" title="klik untuk melihat detail progress">Disetujui 1</a>
                            <?php
                          }else{
                            if($id_pimpinan->kode_jabatan_unit == $id_max){
                             ?>
                             <a class="label label-success" href="#modal_progress" id="custID" data-toggle="modal" data-id="<?php echo $kegiatan->kode_kegiatan;?>" title="klik untuk melihat detail progress">Disetujui 2</a>
                             <?php
                           }else{
                             ?>
                        ...
                        ?>
                        <a class="label label-success" href="#modal_progress" id="custID" data-toggle="modal" data-id="<?php echo $kegiatan->kode_kegiatan;?>" title="klik untuk melihat detail progress">Disetujui 3</a>
                        <?php
                      }elseif ($progress == 0) {
                        ?>
        ...
        <div class="col-lg-12">
          ...
          <form role="form" action="<?php echo base_url(); ?>KegiatanC/post_pengajuan_kegiatan_pegawai" method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" id="pimpinan" name="pimpinan" value="<?php echo $id_pimpinan->kode_jabatan_unit;?>" required> <!-- ambil id_pimpinan berdasarkan user yang login-->
