        ...
        <table border="3" style="border-color: transparent;" >
          ...
          <div class="alert alert-success">
            ...
            <table border="3" style="border-color: transparent;" >
              <tr style="height: 30px">
                <td style="width: 14%">
                  <p>1. Pada menu <strong>Buat RAB</strong> pilih tombol ajukan barang pada pengajuan barang yang ingin diajukan dalam RAB <i class="glyphicon glyphicon-arrow-right"></i> <a class="btn btn-success"><i class="glyphicon glyphicon-ok"></i></a></span>.</p>
                </td>
              </tr>
              <tr style="height: 30px">
                <td>
