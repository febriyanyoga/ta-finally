    ...
    <div class="inner-bg">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4" style="color: white; vertical-align: middle;">
            <center>
              <div>          
                <form role="form" action="<?php echo base_url(); ?>LoginC/kirim_email" method="post" class="registration-form">
                  <div class="form-top" style="margin-top: 20px;">
                    <center><h4 class="text-center" style="margin-top: 30px;">Atur Ulang Kata Sandi</h4></center>
                  </div>
                  ...
                  <div>
                    <center><input type="submit" class="btn btn-primary" value="Kirim" style="padding-left: 5%; padding-right: 5%;"></input></center>
                  </div>
