			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box" style="margin-top: 1%; ">
						<form role="form" action="<?php echo base_url(); ?>UserC/reset" method="post" class="registration-form">
							...
							<div class="form-bottom">
								...
								<div class="form-group">
									...
									<span class="text-danger" style="color: red;"><?php echo form_error('kata_sandi'); ?></span> 
								</div>
								<div>
