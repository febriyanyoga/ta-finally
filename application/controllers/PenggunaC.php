...
class PenggunaC extends CI_Controller {
	...
	public function index(){ //halaman index (dashboard)
		...
		$data['persetujuan_pengajuan_barang']	= $this->PenggunaM->get_persetujuan_barang_desc()->result();
		$data['persetujuan_pengajuan_rab']	= $this->PenggunaM->get_persetujuan_RAB_desc()->result();
