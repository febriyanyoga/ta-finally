...
--
-- Host: 127.0.0.1
-- Generation Time: 07 Jun 2018 pada 03.05
...
(1103, 1528320745, '::1', '56155339'),
(1104, 1528320746, '::1', '37406280');
...
(12, 23, '37693cfc748049e45d87b8c7d8b9aacd.pdf', 61.17, '2018-06-06 14:02:28', NULL),
...
(23, 60, 2, 'Algorhytm', '2018-06-06', '2018-06-06', 10000000, '2018-06-06', 0, NULL, '2018-06-06 14:02:28', NULL),
(24, 61, 1, 'Jalan jalan ke makassar', '2018-06-06', '2018-06-10', 5000000, '2018-06-06', 1, NULL, '2018-06-06 16:00:01', NULL),
(25, 63, 1, 'Liburan ke Bali', '2018-06-06', '2018-06-13', 10000000, '2018-06-06', 11, NULL, '2018-06-06 16:02:27', NULL),
...
(41, 15, 340305180219950002, 1120120075, '2018-06-06 13:54:11');
...
(39, 198706122015042002, 5, 'manajer_keuangan@tedi.com', 'aea1bef2ebd16eb17decf9354ac860cb', 'aktif', '1', '2018-06-06', NULL, '2018-06-05 04:03:20', '2018-06-05 16:15:48'),
...
(60, 384468, 13, 'febriyanyoga@gmail.com', 'aea1bef2ebd16eb17decf9354ac860cb', 'aktif', '1', '2018-06-07', NULL, '2018-06-06 13:58:49', '2018-06-06 14:01:31'),
...
--
ALTER TABLE `akses_menu`
  MODIFY `kode_akses_menu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
--
...
--
ALTER TABLE `captcha`
  MODIFY `captcha_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1105;
--
...
--
ALTER TABLE `file_upload`
  MODIFY `kode_file` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `jabatan_unit`
  MODIFY `kode_jabatan_unit` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
...
--
ALTER TABLE `kegiatan`
  MODIFY `kode_kegiatan` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `log_pengguna`
--
ALTER TABLE `log_pengguna`
  MODIFY `id_log` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `progress`
  MODIFY `kode_progress` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
